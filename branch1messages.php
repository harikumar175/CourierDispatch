...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="branch1messages.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-comments fa-fw"></i>  Admin Office Messages</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <h3>Admin Office Messages</h3>

      </div>
        <?php
       include('dbh.inc.php');
       $sqlget="SELECT*FROM adminmessages";
       $sqldata=mysqli_query($conn,$sqlget);
      while($row=mysqli_fetch_array($sqldata))
      {
        echo"<div class='w3-row'>";
        echo"<div class='w3-col m2 text-center'>";
        echo"<img class='w3-circle' src='adminimg.png' style='width:110px;height:110px'>";
        echo"</div>";
