...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="branch1goods.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-truck fa-fw"></i>  Delivery Goods Details</a>
...
<br>
    <a href="branch1updategoods.php"><button class="w3-button w3-dark-grey"> Update Destination Details <i class="fa fa-arrow-right"></i></button></a>
  </div>
  <hr>
