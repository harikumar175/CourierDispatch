...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="branch1reply.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-commenting-o fa-fw"></i>  Send Messages</a>
...
$sql="INSERT INTO branch1messages(sender,subject,messages,timeline) VALUES('$from','$subject','$messages','$s2');";
mysqli_query($conn,$sql);
echo"<h6>&nbsp;Message Sent to Admin</h6>";
}
?>
  <div class="w3-container">
    <h5>Send Messages:</h5>
    <form action="" target="" method="POST">
            ...
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <input class="w3-input w3-border" type="text" placeholder="Subject" name="subject">
              </div>
            </div>
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
            ...
            <button class="w3-button w3-teal" type="submit" name="admin"><i class="fa fa-user"></i> Admin</button>
          </form>
    </div>
    <script>
    // Get the Sidebar
