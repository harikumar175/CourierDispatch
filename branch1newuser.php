...
<body>
  ...
  <div class="bgimg-2 w3-display-container w3-opacity-min"id="gallery">
    <div class="w3-display-middle">
     <span class="w3-xxlarge w3-text-white w3-wide"><u>BRANCH NEW USER</u></span>
    </div>
  </div>
  <br><br>
...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <div class="w3-col m8 w3-panel">
    <div class="w3-large w3-margin-bottom">
      <i class="fa fa-circle fa-fw w3-text-green w3-xlarge w3-margin-right" aria-hidden="true"></i> You need an Authentication of a Branch User to create a new Account <br>
    </div>


    <form action="login3.inc.php" target="" method="POST">
