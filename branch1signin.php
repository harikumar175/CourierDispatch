...
<body>
  ...
  <div class="bgimg-2 w3-display-container w3-opacity-min"id="gallery">
    <div class="w3-display-middle">
     <span class="w3-xxlarge w3-text-white w3-wide"><u>BRANCH USER SINGIN</u></span>
    </div>
  </div>
  <br><br>
  ...
  <div class="w3-row w3-padding-32 w3-section">
    ...
    <div class="w3-col m8 w3-panel">
      ...
      <form action="login2.inc.php" target="" method="POST">
            ...
            </form>&nbsp;&nbsp;<a href="branch1newuser.php"><button class="w3-button w3-green  w3-section" type="submit" name="signup">
                <i class="fa fa-users"></i> Sign Up
              </button></a>&nbsp;&nbsp;<em>Signup to add a new User<em>
    </div>
  </div>
