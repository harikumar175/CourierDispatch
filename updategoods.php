...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="updategoods.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-address-card-o fa-fw"></i>  Update Goods Details</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <h3>Update Goods Details:</h3>
  

    <form action="updategoods.inc.php" target="" method="POST">
            ...
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <h5>Parcel Sender:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Source" name="source">
              </div>
              <div class="w3-half">
                <h5>Parcel Destination:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Destination" name="destination">
              </div>
            </div>
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <h5>Branch and ID:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Branch no. and ID" name="branch">
              </div>
              <div class="w3-quarter">
                <h5>Weight:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Weight of the Parcel" name="weight">
              </div>
              <div class="w3-quarter">
                <h5>Price:</h5>
            ...
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                ...
                <input class="w3-input w3-border" type="text" placeholder="Product Description" name="description">
              </div>
            </div>
            <hr>
            <h4>Dispatchment Details:</h4>
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <h5>Dispatch Details:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Dispatched or  Not Yet" name="dispatchstatus">
              </div>
              <div class="w3-half">
                <h5>Dispatch Date and Time:</h5>
                <input class="w3-input w3-border" type="text" placeholder="Date and Time" name="dispatchtime">
              </div>
            </div>
            <hr>
            <button class="w3-button w3-red w3-text-white" type="submit" name="branch1"><i class="fa fa-paper-plane"></i> Branch1</button>&nbsp;&nbsp;<button class="w3-button w3-teal w3-text-white"><i class="fa fa-paper-plane"></i> Branch2</button>&nbsp;&nbsp;<button class="w3-button w3-orange w3-text-white"><i class="fa fa-paper-plane"></i> Branch3</button>
          </form>
    </div>
