...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="reply.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-commenting-o fa-fw"></i>  Send Messages</a>
...
$s1=time();
$s2=date("d-F-Y h:i:s a",$s1);
$sql="INSERT INTO adminmessages(sender,messages,timeline) VALUES('$from','$messages','$s2');";
mysqli_query($conn,$sql);
echo"<h6>&nbsp;Message Sent to Branch1</h6>";
}
?>
  <div class="w3-container">
    <h5>Send Messages:</h5>
    <form action="" target="" method="POST">
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <input class="w3-input w3-border" type="text" placeholder="From" name="from">
              </div>
            </div>
            <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              <div class="w3-half">
                <input class="w3-input w3-border" type="text" placeholder="Message" name="messages">
              </div>
            </div>
            <button class="w3-button w3-red" type="submit" name="branch1"><i class="fa fa-paper-plane"></i> Branch1</button>&nbsp;&nbsp;<button class="w3-button w3-blue"><i class="fa fa-paper-plane"></i> Branch2</button>&nbsp;&nbsp;<button class="w3-button w3-orange w3-text-white"><i class="fa fa-paper-plane"></i> Branch3</button>
          </form>
    </div>
  ...
  <div class="w3-container">
    <h5>Branch Office Messages</h5>
    <?php
   include('dbh.inc.php');
   $sqlget="SELECT*FROM branch1messages";
   $sqldata=mysqli_query($conn,$sqlget);
  while($row=mysqli_fetch_array($sqldata))
  {
    echo"<div class='w3-row'>";
    echo"<div class='w3-col m2 text-center'>";
    echo"<img class='w3-circle' src='adminimg2.png' style='width:110px;height:110px'>";
    echo"</div>";
echo"<div class='w3-col m10 w3-container'>";
    echo"<h4>";
    echo $row['sender'];
    echo"<span class='w3-opacity w3-medium'>";
    echo"&nbsp;";
    echo $row['timeline'];
    echo"</span>";
    echo"</h4>";
    ...
    echo $row['messages'];
    echo"</p>";
    echo"<a href='reply.php'>";
    echo"<button class='w3-button w3-dark-grey'>";
    echo"Reply";
