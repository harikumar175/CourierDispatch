...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="branch1search.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-search fa-fw"></i>  Consignment Search</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    ...
    <div class="w3-quarter w3-right">
      <input class="w3-input w3-border" type="text" placeholder="Consignment Number" name="username">
