...
<p class="w3-center"><em>Courier Management</em></p>
  ...
  <div class="w3-row w3-padding-32 w3-section">
    ...
    $sql="INSERT INTO admin(name,username,email,phonenumber,job,id,pwd) VALUES('$name','$username','$email','$phonenumber','$job','$idnumber','$password');";
    ...
    ?>
      ...
      <form action="" target="" method="POST">
        ...
        <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
          <div class="w3-half">
            <h5>Email Address:</h5>
            <input class="w3-input w3-border" type="text" placeholder="Email ID" name="email">
          </div>
        </div>
        ...
        <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
          <div class="w3-half">
            ...
            </form>&nbsp;&nbsp;<a href="adminsignin.php"><button class="w3-button w3-green  w3-section" type="submit" name="signup">
