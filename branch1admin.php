...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="branch1admin.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-user fa-fw"></i>  Branch1 Account Holders</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <h5>Branch Account Holders&nbsp;(Branch 1)</h5>
    <?php
   include('dbh.inc.php');
   $sqlget="SELECT*FROM branch1user";
   $sqldata=mysqli_query($conn,$sqlget);
 echo"<table >";
  echo" <tr>
     <th><b>Si.No</b></th>
  ...
  echo"</table>";
?><br>
    <button class="w3-button w3-dark-grey"> Add Account<i class="fa fa-arrow-right"></i></button>
  </div>
  <hr>
