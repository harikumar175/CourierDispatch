...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="goodsdetail.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-truck fa-fw"></i>  Delivery Goods Details</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-red w3-padding-16">
        ...
        <div class="w3-right">
          <?php
       include('dbh.inc.php');
       $sqlget="SELECT count(s_no) AS total FROM admin";
       $sqldata=mysqli_query($conn,$sqlget);
       $print_data=mysqli_fetch_assoc($sqldata);
       $num_rows=$print_data['total'];
       echo"<h2>";
       echo $num_rows ;
       echo"</h2>";
       ?>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-teal w3-padding-16">
        ...
        <div class="w3-right">
          <?php
       include('dbh.inc.php');
       $sqlget="SELECT count(si_no) AS total FROM branch1";
       $sqldata=mysqli_query($conn,$sqlget);
       $print_data=mysqli_fetch_assoc($sqldata);
       $num_rows=$print_data['total'];
       echo"<h2>";
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-orange w3-text-white w3-padding-16">
        ...
        <div class="w3-right">
          <?php
       include('dbh.inc.php');
       $sqlget="SELECT count(id) AS total FROM branch1user";
       $sqldata=mysqli_query($conn,$sqlget);
       $print_data=mysqli_fetch_assoc($sqldata);
       $num_rows=$print_data['total'];
       echo"<h2>";
  ...
  echo" <tr>
     <th><b>Si.No</b></th>
      ...
      <th><b>Parcel Source</b></th>
      <th><b>Parcel Destination</b></th>
      <th><b>Branch and BranchId</b></th>
      <th><b>Parcel Weight</b></th>
  ...
  while($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
  {
    ...
    echo"</b></td><td>";
    echo $row['parcel_sender'];
    echo"</td><td>";
    echo $row['parcel_destination'];
    echo"</td><td>";
    echo $row['branch'];
    echo"</td><td>";
    echo $row['weight'];
  ...
  <a href='crud.php?delete=<?php echo $row['si_no'];?>'";
    <?php
  echo"<button class='w3-button w3-red' type='submit' name='delete'>";
    echo"Delete";
    echo"</button>";
    echo"</a><br/><br/>";
    echo"<button class='w3-button w3-blue'>";
    echo"Edit";
    echo"</td></tr>";
  }
  echo"</table>";?>
...
<br>
    <a href="updategoods.php"><button class="w3-button w3-dark-grey"> Add Parcel Details<i class="fa fa-arrow-right"></i></button></a>
  </div>
  <hr>
